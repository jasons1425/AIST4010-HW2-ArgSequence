...
# isarg model
isarg_model_weights = r"trials/isarg_embed9583.pth"
isarg_model_config = {
    "in_dim": 24,
    "out_dim": 2,
    "in_ksize": 3,
...
# argclass model
argcls_model_weights = r"trials/argclass_embed9606.pth"
argcls_model_config = {
    "in_dim": 24,
    "out_dim": 14,
    "in_ksize": 3,
...
for inputs, ids in test_loader:
    ...
    outputs_isarg, outputs_argcls = isarg_model(inputs), argcls_model(inputs)
    (_, preds_isarg), (__, preds_argcls) = torch.topk(outputs_isarg, 1, dim=1), torch.topk(outputs_argcls, 1, dim=1)
    final_preds = ((preds_isarg * (preds_argcls + 1)) - 1) % 15
